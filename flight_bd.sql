...
(
    ...
    departure_airport_code CHAR(3) REFERENCES airoport (code) NOT NULL ,
    arrival_date TIMESTAMP NOT NULL ,
    arrival_airport_code CHAR(3) REFERENCES airoport (code) NOT NULL ,
...
insert into airoport (code, country, city)
...
-- Кто летел позавчера рейсом Минск (MNK) - Лондон (LDN) на месте B!?
